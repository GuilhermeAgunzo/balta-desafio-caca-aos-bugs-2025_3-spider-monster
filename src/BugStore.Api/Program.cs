...
builder.Services.AddTransient<BugStore.Api.Abstractions.Handlers.Customers.IHandler, BugStore.Api.Handlers.Customers.Handler>();
builder.Services.AddTransient<BugStore.Api.Abstractions.Handlers.Products.IHandler, BugStore.Api.Handlers.Products.Handler>();
builder.Services.AddTransient<BugStore.Api.Abstractions.Handlers.Orders.IHandler, BugStore.Api.Handlers.Orders.Handler>();
...
app.MapPost("/v1/customers", async Task<IResult> (
      ...
      BugStore.Api.Requests.Customers.Create request,
...
app.MapGet("/v1/customers", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Customers.Get
    {
        PageNumber = page,
        PageSize = pageSize
    };
...
app.MapGet("/v1/customers/{id}", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Customers.GetById
    {
        Id = id
    };
...
app.MapPut("/v1/customers/{id}", async Task<IResult> (
      [FromServices] BugStore.Api.Abstractions.Handlers.Customers.IHandler customerHandler,
      Guid id,
      BugStore.Api.Requests.Customers.Update request,
      CancellationToken cancellationToken = default) =>
{
    request.Id = id;
...
app.MapDelete("/v1/customers/{id}", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Customers.Delete
    {
        Id = id
    };
...
app.MapPost("/v1/products", async Task<IResult> (
      ...
      BugStore.Api.Requests.Products.Create request,
      CancellationToken cancellationToken = default) =>
{
...
app.MapGet("/v1/products/{id}", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Products.GetById
    {
        Id = id
    };
...
app.MapGet("/v1/products", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Products.Get
    {
...
app.MapPut("/v1/products/{id}", async Task<IResult> (
      [FromServices] BugStore.Api.Abstractions.Handlers.Products.IHandler productHandler,
      Guid id,
      BugStore.Api.Requests.Products.Update request,
      CancellationToken cancellationToken = default) =>
{
    request.Id = id;
...
app.MapDelete("/v1/products/{id}", async Task<IResult> (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Products.Delete
    {
        Id = id
    };
...
app.MapPost("/v1/orders", async (
      ...
      BugStore.Api.Requests.Orders.Create request,
      CancellationToken cancellationToken = default) =>
{
...
app.MapGet("/orders/{id}", async (
      ...
      CancellationToken cancellationToken = default) =>
{
    var request = new BugStore.Api.Requests.Orders.GetById { Id = id };
